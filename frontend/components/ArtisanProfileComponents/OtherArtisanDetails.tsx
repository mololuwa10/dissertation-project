...
// import {faMastercard} from "@fortawesome/free-brands-svg-icons";
					...
					<div className="flex lg:flex-row justify-evenly items-start space-x-20">
						...
						<div className="block items-start lg:items-center lg:justify-around">
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.stories}
								</p>
							</div>
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.returnPolicy}
								</p>
							</div>
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.specializations}
								</p>
							</div>
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.servicesOffered}
								</p>
							</div>
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.materialsUsed}
								</p>
							</div>
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.shippingPolicies}
								</p>
							</div>
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.privacyPolicy}
								</p>
							</div>
							...
							<div className="lg:pl-10 mt-6 lg:mb-0 lg:border-l-2">
								...
								<p className="text-sm text-gray-600">
									{userDetails?.artisanProfile?.termsConditions}
								</p>
							</div>
						</div>
					</div>
